...
# expanded states
parser.add_argument('-model', type=str, default="BasicNN", help="Supported models: BasicNN and AdaptableLSTM")
...
parser.add_argument('-hierarchical', type=str, default=None, help="Possible non-none values are Shared and Separate. Seems to work, but requires nrclass to be True if this is not None.")
...
parser.add_argument('-cluster_by', type=str, default=None, help="Cluster stuff all probably doesn't work?")
